...
public class HttpUtils {
	 ...
	 * @throws Exception 
     */
    public static String sendPost(String url, Map<String, Object> map) throws Exception {
    	CloseableHttpClient httpclient = HttpClients.createDefault();
        MultipartEntityBuilder multipartEntity = MultipartEntityBuilder.create(); 
        for (Map.Entry<String, Object> entity : map.entrySet()) {
        	if (entity.getValue() instanceof File) {
        		multipartEntity.addPart(entity.getKey(), new FileBody((File) entity.getValue()));
			} else {
				multipartEntity.addPart(entity.getKey(), new StringBody(entity.getValue().toString(), ContentType.APPLICATION_JSON));
			}
        }
