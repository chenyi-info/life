$(function(){
	var headUpload = function() {
		...
		WebUploader.create({
			...
			onUploadSuccess: function(file, response) {
				...
				$('.friend-head').css('background-image','url('+ossImage+')');
	...
	var showInfo = function(){
		...
		if(className == 'motto'){
			$('.friend-content .'+className + ' p').text($(this).val());	
		}else{
			$('.friend-content .'+className).text($(this).val());
		}
	}
	...
	var initializeUi = function(){
		$('.friend-content').delegate('.friend-head','hover',flipShow);
		//$('.friend-content').delegate('.friend-head','mouseout',flipHide);
		$('.motto').hide();
		$('.main_right').delegate('input[type=text]','change',showInfo);
